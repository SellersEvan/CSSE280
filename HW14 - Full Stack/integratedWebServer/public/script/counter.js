...
class counter {
    ...
    getValue() {
        return parseInt( this.displayElmement.getAttribute( "data-count" ) );
    }
    ...
    display( value ) {
        this.displayElmement.innerText = "Count = " + value;
        this.displayElmement.setAttribute( "data-count", value ); 
    }
}